...
<aside class="aside" data-fls-dynamic=".main__inner, 1199.98, 2">
    <form action="<?=$arResult["FORM_ACTION"]?>" method="get" data-fls-spollers="1199.98,max" class="aside-main__spoller spollers">
                ...
                ?>
                    <div data-fls-spollers="360,min" class="aside__spoller spollers">
                        <details class="aside__spoller-item spollers__item">
                            <summary class="aside__spoller-title aside-title spollers__title"><?=$item['NAME']?></summary>
                                ...
                                ?>
                                    <div class="aside__form-item form__item">
                                        <div class="aside__form-checkbox checkbox">
                                            <input class="aside__form-input checkbox__input" id="<?=$val['CONTROL_ID']?>" type="checkbox" name="<?=$val['CONTROL_NAME']?>">
                                            <label class="aside__form-label checkbox__label" for="<?=$val['CONTROL_ID']?>">
...
<!--																<span class="aside__form-count">(253)</span>-->
            ...
            <div class="aside-main__controls">
                ...
                <button class="aside-main__btn aside-main__btn--show">Показать</button>
            </div>
        </details>
    </form>
</aside>
